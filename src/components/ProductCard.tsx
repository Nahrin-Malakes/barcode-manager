...
export const ProductCard = ({ name, barcode, price }: Props) => {
  ...
  const EditProductModal = () => {
    ...
    return (
      <>
        <button
          className="text-white mt-2 cursor-pointer bg-blue-700 hover:bg-blue-800 mx-4 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-700 dark:hover:bg-blue-800"
          type={"submit"}
          onClick={() => setShowModal(true)}
        >
          Edit
  ...
  return (
    <div className="max-w-sm bg-white flex rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
